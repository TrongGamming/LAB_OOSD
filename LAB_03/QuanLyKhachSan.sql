-- =====================================================================
-- HỆ THỐNG QUẢN LÝ KHÁCH SẠN – CSDL ORACLE 19c
-- Chuyển từ thiết kế SQL Server trong đề bài (Bài 3) sang Oracle.
-- Schema/User: KHACHSAN   Service: ORCL   Port: 1521
-- Chạy bằng chính user KHACHSAN (xem README để tạo user).
-- =====================================================================
SET DEFINE OFF;

PROMPT [1/4] XOA OBJECT CU...
...
-- Đề để nhân viên tự gõ số phiếu; trên Oracle dùng sequence cho chắc chắn không trùng.
